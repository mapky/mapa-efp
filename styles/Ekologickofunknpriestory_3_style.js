var size = 0;
var placement = 'point';
function categories_Ekologickofunknpriestory_3(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case '9 Ostatné plochy':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(222,143,188,0.8)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_Ekologickofunknpriestory_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Ekologickofunknpriestory_3(feature, value, size, resolution, labelText,
